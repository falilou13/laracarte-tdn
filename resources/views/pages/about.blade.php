...
@section('content')
    <div class="container">
    	...
    	<div class="row">
    		<div class="col-md-6">
    			<p class="alert alert-warning">
    				<strong><i class="fa fa-exclamation-triangle" aria-hidden="true"></i>This app has been built by <a href="https://twitter/@faliloudiallo13">@falilou13</a> for learning purposes.</strong>
    			</p>
    		</div>
    	</div>
        ...
        <p>Laramap is the website by witch laracarte was inspired :). </p>
